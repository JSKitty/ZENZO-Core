...
/** Track confirm delays up to 5 blocks, can't estimate beyond that */
static const unsigned int MAX_BLOCK_CONFIRMS = 5;
...
static const double INF_FEERATE = 83000000;
static const double MIN_PRIORITY = 10;
static const double MAX_PRIORITY = 1e16;
static const double INF_PRIORITY = 1e9 * 83000000;
